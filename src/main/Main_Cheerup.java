...
public class Main_Cheerup {
	...
	public void main() throws URISyntaxException {
		...
		TestdataOutReader.init(testfilePath + "cheerup.out");
		TestdataInReader testdataInReader = new TestdataInReader(testfilePath + "cheerup.in");
		...
		unit = new Unit("Servant1", 1000, 0, 0, new SimpleAiDecisionMaker());
		troop1.addUnit(unit);
		
		unit = new Unit("Servant2", 1000, 0, 0, new SimpleAiDecisionMaker());
		troop1.addUnit(unit);
		
		unit = new Unit("Servant3", 1000, 0, 0, new SimpleAiDecisionMaker());
		troop1.addUnit(unit);
		
		unit = new Unit("Servant4", 1000, 0, 0, new SimpleAiDecisionMaker());
		troop1.addUnit(unit);
		
		unit = new Unit("Servant5", 1000, 0, 0, new SimpleAiDecisionMaker());
		troop1.addUnit(unit);
		...
		unit = new Unit("Slime1", 500, 0, 0, new SimpleAiDecisionMaker());
		troop2.addUnit(unit);
