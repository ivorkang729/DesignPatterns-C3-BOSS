...
public class Main_Poison {
	...
	public void main() throws URISyntaxException {
		...
		TestdataOutReader.init(testfilePath + "poison.out");
		TestdataInReader testdataInReader = new TestdataInReader(testfilePath + "poison.in");
		DecisionMaker testDataDecisionMaker = new TestDataDecisionMaker(testdataInReader);
		
//		Troop1
		Troop troop1 = new Troop();
		
		Unit unit = new Unit("英雄", 1000, 500, 0, testDataDecisionMaker);
...
//		Troop2
		...
		unit = new Unit("Slime1", 120, 90, 50, new SimpleAiDecisionMaker());
		troop2.addUnit(unit);
		
		unit = new Unit("Slime2", 120, 90, 50, new SimpleAiDecisionMaker());
		troop2.addUnit(unit);
		
		unit = new Unit("Slime3", 120, 9000, 50, new SimpleAiDecisionMaker());
		troop2.addUnit(unit);
